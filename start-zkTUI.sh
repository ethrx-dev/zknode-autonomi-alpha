...
::::::::::::  .   :::.    :::.              ::              ::::::::::.   .::::::::::::.    .        :      
'`````;;;;;; .;;,.`;;;;,  `;;;              ;;;              `;;;```.;;;,;';; `;;;```.;;;   ;;,.    ;;;  ;;,
    .n[['[[[[[╱'    [[[[[. '[[ ,ccc,   ,c[[[cc,,cc[[[cc.      `]]nnn]]',[' [[  `]]nnn]]'    [[[[, ,[[[[,    
  ,$$P" _$$$$,      $$$ "Y$c$$$$$"c$$$$$""""Y$$$$$___──'       $$$""   $P__$$c  $$$""       $$$$$$$$"$$$ $$$
,888bo,_"888"88o,   888    Y88888   8888o,,od8P88b    ,o,      888o    `"""88"  888o        888 Y88" 888o888
 `""*UMM MMM "MMP"  MMM     YM "YUMMP "YUMMMP"  "YUMMMMP"      YMMMb       MM   YMMMb       MMM  M'  "MMMMMM
...
cmd_autonomi_upload() {
    ...
    if [ -n "$f" ] && [ -f "$f" ]; then
        ...
        DATA_PAYMENTS_ADDRESS='0x0000000000000000000000000000000000000000' \
...
cmd_autonomi_balance() {
    ...
    echo -e "  ${K}│${R}  Token:    ${K}0x0000000000000000000000000000000000000000${R}  ${K}│${R}"
    echo -e "  ${K}└──────────────────────────────────────────────────────┘${R}"
    echo ""; echo -e "  ${K}[Press any key]${R}"; read -rsn1
}
