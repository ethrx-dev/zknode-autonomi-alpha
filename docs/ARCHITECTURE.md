...
>
> **Which deployment profile?** See [SCM4 Architecture Options](ARCHITECTURE_OPTIONS.md) — local PoC, VPS-client, or hybrid. Do not deploy `main` unchanged onto a local-topology box (dashboard health logic differs).
